<template>
<div>
    <div class="page-component" :style="{height:userAddHeight,overflow:'auto'}">
        <section class="content element-doc content">
            <h2 id="icon-tu-biao">
                <a href="https://element.eleme.cn/#/zh-CN/component/icon#icon-tu-biao" aria-hidden="true" class="header-anchor">¶</a> Icon 图标
            </h2>
            <p>提供了一套常用的图标集合。</p>
            <h3 id="shi-yong-fang-fa">
            <a href="https://element.eleme.cn/#/zh-CN/component/icon#shi-yong-fang-fa" aria-hidden="true" class="header-anchor">¶</a> 使用方法
            </h3>
            ...
            <div class="demo-block demo-zh-CN demo-icon">
                ...
                <div class="meta">
                    ...
                    <div class="highlight" style="width: 100%;">
                        <pre><code class="html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"el-icon-edit"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span> <span class="hljs-attr">icon</span>=<span class="hljs-string">"el-icon-search"</span>&gt;</span>搜索<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
                ...
                <div class="demo-block-control">
                    ...
                    <span style="display: none;">显示代码</span>
                </div>
            </div>
        ...
        <div class="footer-nav"><span class="footer-nav-link footer-nav-left"><i class="el-icon-arrow-left"></i>
                ...
                Button 按钮
                <i class="el-icon-arrow-right"></i></span></div>
    </div>
</div>
</template>
